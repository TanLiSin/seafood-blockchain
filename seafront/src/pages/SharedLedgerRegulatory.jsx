...
function SharedLedgerRegulatory() {
    ...
    <div className="regulatory-page">
      <header>
        ...
        <nav className="nav-links">
          ...
          <Link to="/shared-ledger-regulatory" className="active">SHARED LEDGER</Link>
      ...
      <main>
        <div className="welcome-section">
          <h2>Shared Ledger - Regulatory View</h2>
...
export default SharedLedgerRegulatory;
