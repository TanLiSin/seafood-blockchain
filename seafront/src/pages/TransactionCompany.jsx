...
import './Record.css';
import TransactionFormCompany from './TransactionFormCompany';
import './Search.css';
import confetti from 'canvas-confetti';

function TransactionCompany() {
  ...
  const handleDeleteConfirmed = async () => {
    try {
      await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/transactions/${transactionToDelete}`, { method: 'DELETE' });
    ...
    <div className="company-page">
      <header>
        ...
        <nav className="nav-links">
          ...
          <Link to="/transaction-company" className="active">TRANSACTION</Link>
