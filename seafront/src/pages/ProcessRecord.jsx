...
import './Search.css';
import ProcessRecordForm from './ProcessRecordForm';
...
function ProcessRecord() {
  ...
  const filteredRecords = records.filter((record) =>
    ...
    record.process_method.toLowerCase().includes(searchTerm.toLowerCase())
  );
    ...
    <div className="company-page">
      <header>
        ...
        <nav className="nav-links">
          ...
          <Link to="/process-record" className="active">PROCESS RECORD</Link>          
      ...
      <main>
        <div className="welcome-section">
          <h2>Process Record Management</h2>
          ...
          <button onClick={() => {
            ...
            {showForm ? 'Close Form' : 'Register New Process Record'}
          </button>
            ...
            <div className="record-table-container">
              <table className="record-table">
                ...
                {filteredRecords.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="8">No process records found.</td>
                  </tr>
                )}
              </tbody>
              </table>
          ...
          {showDeleteModal && (
            <div className="modal-overlay">
              <div className="modal-box warning">
                ...
                <p>Are you sure you want to delete this process record?</p>
          ...
          {showSuccessModal && (
            <div className="modal-overlay">
              <div className="modal-box success">
                ...
                <p>The process record has been successfully deleted!</p>
